...
export default function Home() { // Defines the main functional component, Home
  ...
  async function fetchArtworks() {
    ...
    setArtworks(data.data); // Updates the artworks state with the data array evneloped in data property
    setLoading(false); // Ends the loading indicator by setting loading to false signaling data fetch
                        //is completed
  }
